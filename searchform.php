...
<form role="search" method="get" class="search-form form-inline my-2 my-lg-0"
    ...
    <label for="<?php echo $unique_id; ?>">
        <span class="visually-hidden"><?php echo _x( 'Search for:', 'label', 'text_domain' ); ?></span>
    </label>
    <input type="search" id="<?php echo $unique_id; ?>" class="search-field form-control me-sm-2"
    ...
    <button type="submit" class="search-submit btn btn-outline-success my-2 my-sm-0">
        <span class="visually-hidden"><?php echo _x( 'Search', 'submit button', 'text_domain' ); ?></span>
